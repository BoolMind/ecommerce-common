 ...
 */
export const Environment_ContextVariableSchema = /*@__PURE__*/ messageDesc(file_cel_expr_conformance_env_config, 0, 1);
/**
 * Describes the message cel.expr.conformance.Validator.
 * Use `create(ValidatorSchema)` to create a new message.
 */
export const ValidatorSchema = /*@__PURE__*/ messageDesc(file_cel_expr_conformance_env_config, 1);
/**
 * Describes the message cel.expr.conformance.Feature.
 * Use `create(FeatureSchema)` to create a new message.
 */
export const FeatureSchema = /*@__PURE__*/ messageDesc(file_cel_expr_conformance_env_config, 2);
/**
 * Describes the message cel.expr.conformance.Extension.
 * Use `create(ExtensionSchema)` to create a new message.
 */
export const ExtensionSchema = /*@__PURE__*/ messageDesc(file_cel_expr_conformance_env_config, 3);
/**
 * Describes the message cel.expr.conformance.LibrarySubset.
 * Use `create(LibrarySubsetSchema)` to create a new message.
 */
export const LibrarySubsetSchema = /*@__PURE__*/ messageDesc(file_cel_expr_conformance_env_config, 4);

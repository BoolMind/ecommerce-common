 ...
 */
export function isIpPrefix(version, strict = false) {
    if (version == 6) {
 ...
 */
export function isHostAndPort(portRequired) {
    if (this.length == 0) {
        return false;
    }
 ...
 */
export function bytesContains(sub) {
    if (sub.length === 0) {
        return true;
    }
 ...
 */
export function bytesStartsWith(sub) {
    if (sub.length > this.length) {
        return false;
    }
 ...
 */
export function bytesEndsWith(sub) {
    if (sub.length > this.length) {
        return false;
    }

...
exports.isInf = isInf;
exports.isIp = isIp;
exports.isIpPrefix = isIpPrefix;
exports.isHostname = isHostname;
exports.isHostAndPort = isHostAndPort;
exports.isEmail = isEmail;
exports.isUri = isUri;
exports.isUriRef = isUriRef;
exports.unique = unique;
exports.bytesContains = bytesContains;
exports.bytesStartsWith = bytesStartsWith;
exports.bytesEndsWith = bytesEndsWith;
...
function isInf(sign) {
    sign ?? (sign = 0);
    return ((sign >= 0 && this === Number.POSITIVE_INFINITY) ||
 ...
 */
function isIpPrefix(version, strict = false) {
    if (version == 6) {
 ...
 */
function isHostAndPort(portRequired) {
    if (this.length == 0) {
        return false;
    }
    ...
    if (this[0] == "[") {
        ...
        switch (end + 1) {
            ...
            case splitIdx: // port
                return (isIp.call(this.substring(1, end), 6) &&
...
function unique() {
    return Array.from(this.values()).every((a, index, arr) => {
        if ((0, cel_1.isCelUint)(a)) {
            for (let i = 0; i < arr.length; i++) {
                if (i == index) {
                    continue;
                }
                const b = arr[i];
                if ((0, cel_1.isCelUint)(b) && b.value === a.value) {
                    return false;
                }
            }
            return true;
        ...
        if (a instanceof Uint8Array) {
            for (let i = 0; i < arr.length; i++) {
                ...
                const b = arr[i];
                if (b instanceof Uint8Array && (0, reflect_1.scalarEquals)(protobuf_1.ScalarType.BYTES, b, a)) {
                    return false;
                }
            }
            return true;

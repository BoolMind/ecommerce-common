...
exports.getTestDataForPaths = getTestDataForPaths;
const protocompile_1 = require("@bufbuild/protocompile");
const protobuf_1 = require("@bufbuild/protobuf");
function getTestDataForPaths() {
    const file = (0, protocompile_1.compileFile)(`
    syntax="proto2";
    message User {
  ...
  `);
    const registry = (0, protobuf_1.createRegistry)(file);

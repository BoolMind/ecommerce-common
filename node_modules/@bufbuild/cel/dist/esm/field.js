...
import { isWrapperDesc, ListValueSchema, StructSchema, ValueSchema, } from "@bufbuild/protobuf/wkt";
...
export function accessByIndex(obj, index) {
 ...
 */
export function accessByName(obj, name) {
    if (typeof obj !== "object" || obj === null) {
        return undefined;
    }
    if (isCelMap(obj)) {

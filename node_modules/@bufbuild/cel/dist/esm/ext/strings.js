...
function indexOf(substr, startN) {
    if (startN === undefined) {
...
function lastIndexOf(substr, startN) {
    if (startN === undefined) {
...
function replace(substr, repl, num) {
        ...
        case "object":
            switch (true) {
                ...
                case isReflectMessage(val, TimestampSchema):
                    return toJson(TimestampSchema, val.message);
                case isReflectMessage(val, DurationSchema):
                    return toJson(DurationSchema, val.message);
                case val instanceof Uint8Array:
...
function formatPlaceholder(c, val, precision) {
    switch (c) {
        case "e":

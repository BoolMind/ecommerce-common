...
function convertToDate(msg, tz) {
    ...
    return new Date(year, month, day, hour, minute, second, val.getUTCMilliseconds());
}
const { STRING, INT } = CelScalar;
function celTimeMethods(name, func) {
    function method(tz) {
        ...
        try {
            ...
            throw new Error(`Error converting ${result} of ${String(date)} of ${toJson(TimestampSchema, this.message)} to BigInt`);
        }
    }
    return [

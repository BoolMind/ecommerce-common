...
import { EvalAttr } from "./planner.js";
import { isCelError, celError, } from "./error.js";
import { accessByIndex, accessByName, isSet } from "./field.js";
import { isCelUint } from "./uint.js";
import { CelScalar, celType, listType, mapType, objectType, } from "./type.js";
...
class ConditionalAttr {
    ...
    resolve(vars) {
        ...
        return celError(`found no matching overload for _?_:_ applied to '(${celType(cond).name})'`, this.id);
    }
}
class MaybeAttr {
    id;
...
export class ConcreteAttributeFactory {
    registry;
    container;

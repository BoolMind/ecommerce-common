...
exports.ParseSyntaxError = exports.ParseError = void 0;
exports.parse = parse;
var runtime;
(function (runtime) {
...
class ParseError extends Error {
    ...
    static #formatMessage(message, location) {
...
class ParseSyntaxError extends ParseError {
    expected;
    found;
    ...
    static #formatMessage(expected, found) {
        function encode(s) {
            return ("'" +
                s.replace(/[\\\x07\b\f\n\r\t\v']/g, (match) => {
                    switch (match) {
...
const logic_manager_js_1 = require("./logic-manager.js");
...
function parse(input, options = {}) {
    ...
    throw new ParseSyntaxError(failedExpectations.map((e) => e.expectation), remainder.slice(0, 1), runtime.getLocation(parse$source, input, remainder, remainder));
    function item103(offset, digits) {
        return builder.newDoubleExpr(offset(), digits);
    }
    function item126(offset, digits) {
        return builder.newUnsignedInt64Expr(offset(), digits);
    }
    function item142(offset, digits) {
        return builder.newInt64Expr(offset(), digits);
    }
    function item235(value) {
        return parseInt(value, 16);
    }
    function item243(value) {
        return parseInt(value, 16);
    }
    function item251(value) {
        return parseInt(value, 16);
    }
    function item264(value) {
        return parseInt(value, 8);
    }
    function item273(value) {
        switch (value) {
            case "a":
                return "\x07";
            case "b":
    ...
    function item529(offset, ops, expr) {
        /* : Expr */
        if (ops.length % 2 === 0) {
            return expr;
        }
    ...
    function item559(offset, operator, nextExpr) {
        return (prevExpr) => builder.newCallExpr(offset(), operator, [prevExpr, nextExpr]);
    }
    function item561(multiplication, tail) {
        /* : Expr */
        if (tail === null) {
    ...
    function item588(operator) {
        return `_${operator}_`;
    }
    function item592() {
        return "@in";
    }
    function item595(offset, operator, nextExpr) {
        return (prevExpr) => builder.newCallExpr(offset(), operator, [prevExpr, nextExpr]);
    }
    function item597(addition, tail) {
        /* : Expr */
        if (tail === null) {
            return addition;
        }
    ...
    function item603(offset, relation) {
        /* : Expr */
        if (relation.length === 1) {
            return relation[0];
        }
        const logicManager = logic_manager_js_1.default.newBalancingLogicManager(builder, "_&&_", relation[0]);
        for (let i = 1; i < relation.length; i += 1) {
            logicManager.addTerm(offset(), relation[i]);
        }
        return logicManager.toExpr();
    }
    function item609(offset, and) {
        /* : Expr */
        if (and.length === 1) {
            return and[0];
        }
        const logicManager = logic_manager_js_1.default.newBalancingLogicManager(builder, "_||_", and[0]);
        for (let i = 1; i < and.length; i += 1) {
            logicManager.addTerm(offset(), and[i]);
        }
        return logicManager.toExpr();
    }
    function item621(t, f) {
        /* : [Expr, Expr] */
        return [t, f];
    }
    function item623(offset, or, tail) {
        /* : Expr */
        if (tail === null) {
            return or;
        }
    ...
    function item4(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item623(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    function item362(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item390(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    function item369(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item378((message, location = runtime.getLocation(parse$source, input, text, result.remainder), name) => {
    ...
    function item391(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item434(() => input.length - text.length, result.value[0], result.value[1], result.value[2]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // return selector;
    // }
    function item400(text) {
        const result = item402(text);
        if (result.success === true) {
            return {
                success: true,
                value: item407((message, location = runtime.getLocation(parse$source, input, text, result.remainder), name) => {
                    throw new ParseError(message, location, name);
                }, result.value),
                remainder: result.remainder,
                failedExpectations: [],
    ...
    function item417(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item427(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // key:Expr ":" value:Expr
    // { return builder.newMapEntry(offset(), key, value) }
    function item466(text) {
        const result = item467(text);
        if (result.success === true) {
            return {
                success: true,
                value: item472(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // "." S func:Selector S "(" args:ExprList ")"
    // { return ((prevExpr: Expr) => builder.newMemberCallExpr(offset(), prevExpr, func, args)) }
    function item498(text) {
        const result = item499(text);
        if (result.success === true) {
            return {
                success: true,
                value: item506(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // return builder.newCallExpr(offset(), `${ops[0]}_`, [expr]);
    // }
    function item517(text) {
        const result = item518(text);
        if (result.success === true) {
            return {
                success: true,
                value: item529(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // S operator:( o:[*/%] { return `_${o}_` } ) nextExpr:Unary
    // { return ((prevExpr: Expr) => builder.newCallExpr(offset(), operator, [prevExpr, nextExpr])) }
    function item534(text) {
        const result = item535(text);
        if (result.success === true) {
            return {
                success: true,
                value: item544(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    function item551(text) {
        ...
        if (result.success === true) {
            return {
                success: true,
                value: item559(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }
    ...
    // S operator:Relop nextExpr:Addition
    // { return ((prevExpr: Expr) => builder.newCallExpr(offset(), operator, [prevExpr, nextExpr])) }
    function item566(text) {
        const result = item567(text);
        if (result.success === true) {
            return {
                success: true,
                value: item595(() => input.length - text.length, result.value[0], result.value[1]),
                remainder: result.remainder,
                failedExpectations: [],
            };
        }

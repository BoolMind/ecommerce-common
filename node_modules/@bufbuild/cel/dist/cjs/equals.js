...
function equals(lhs, rhs) {
    ...
    if ((0, uint_js_1.isCelUint)(lhs)) {
        lhs = lhs.value;
    }
    if ((0, uint_js_1.isCelUint)(rhs)) {
        rhs = rhs.value;
    }
    ...
    switch (true) {
        ...
        case (0, list_js_1.isCelList)(lhs):
            return (0, list_js_1.isCelList)(rhs) && equalsList(lhs, rhs);
        case (0, map_js_1.isCelMap)(lhs):
            return (0, map_js_1.isCelMap)(rhs) && equalsMap(lhs, rhs);
        case (0, type_js_1.isCelType)(lhs):
            return (0, type_js_1.isCelType)(rhs) && equalsType(lhs, rhs);
    }
    // Messages
    if ((0, reflect_1.isReflectMessage)(lhs)) {
        ...
        return (0, protobuf_1.equals)(lhs.desc, lhs.message, rhs.message, {
            registry: (0, eval_js_1.getEvalContext)().registry,
            unpackAny: true,
            unknown: true,
            extensions: true,
        });
...
function equalsType(lhs, rhs) {
    return lhs.kind === rhs.kind && lhs.name === rhs.name;
}
function equalsList(lhs, rhs) {

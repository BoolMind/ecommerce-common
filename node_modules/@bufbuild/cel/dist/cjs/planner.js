...
exports.EvalAttr = exports.Planner = void 0;
...
class EvalCall {
    ...
    eval(ctx) {
        ...
        if ((0, error_js_1.isCelError)(target)) {
            return target;
        }
        const vals = [];
        ...
        return (0, error_js_1.celError)(`found no matching overload for '${this.name}' applied to '${target !== undefined ? `${(0, type_js_1.celType)(target)}.` : ""}(${vals
    ...
    eval(ctx) {
        ...
        for (const arg of this.args) {
            ...
            if ((0, error_js_1.isCelError)(val)) {
                ...
                errors.push((0, error_js_1.celError)(`type mismatch: expected bool, got ${(0, type_js_1.celType)(val)}`, this.id));
            }
        }
        if (errors.length > 0) {

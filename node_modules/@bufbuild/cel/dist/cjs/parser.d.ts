declare namespace runtime {
    ...
    function isFailure(r: Result<unknown>): r is Failure;
    function getLocation(source: string | GrammarLocation | undefined, input: string, start: string, remainder: string): runtime.LocationRange;
    function getRange(source: string | GrammarLocation | undefined, input: string, start: string, remainder: string): {
        source: string | GrammarLocation | undefined;
        start: number;
        end: number;
    };
    function getText(start: string, remainder: string): string;
}
export declare class ParseError extends Error {
    #private;
    rawMessage: string;
    location: runtime.LocationRange;
    constructor(message: string, location: runtime.LocationRange, name?: string);
}
export declare class ParseSyntaxError extends ParseError {
    #private;
